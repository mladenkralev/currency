...
public class MessagingApplication {
    @Value("${scheduler.statistics.exchange}")
    public static String EXCHANGE_NAME = "appExchange";
    ...
    @Bean
    public Binding declareBindingSpecific(Queue queue, TopicExchange exchange) {
